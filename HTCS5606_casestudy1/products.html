...
<div id="header">
    ...
    <div id="main">
        <div class="wrapper">
            ...
            <div class="items">
                <div class="item">
                    <img src="image/Adult Oral Care Dry Cat Food.jpeg" height="150" width="150"/>
                    <br>
                ...
                <div class="item">
                    <img src="image/Grain Free Trout Dry Cat Food.jpeg" height="150" width="150"/><br>
                ...
                <div class="item">
                    <img src="image/Royal Canin Second Age Kitten.jpeg" height="150" width="150"/><br>
                ...
                <div class="item">
                    <img src="image/Royal Canin Mother & Babycat.jpeg" height="150" width="150"/><br>
                    <h2>Royal Canin Mother & Babycat</h2>
                    <p>PRICE: $2.99</p>
                    <button class="add-to-cart" type="button">ADD TO CART</button>
                </div>

                <div class="item">
                    <img src="image/Grain Free Chicken Wet Cat Food.png" height="150" width="150"/><br>
        ...
        <div class="wrapper">
            ...
            <div class="items">
                <div class="item">
                    <img src="image/Bone Brew Frozen Broth 350ml.jpeg" height="150" width="150"/>

                    <br>
                    <h2>Bone Brew Frozen Broth 350ml</h2>
                    <p>PRICE: $5.99</p>
                    <button class="add-to-cart" type="button">ADD TO CART</button>
                </div>

                <div class="item">
                    <img src="image/Purely Pets Frozen Beef & Lamb.jpeg" height="150" width="150"/>
                ...
                <div class="item">
                    <img src="image/Possyum Supreme Dog Roll.jpeg" height="150" width="150"/>
                    <br>
                ...
                <div class="wrapper">
                    ...
                    <div class="items">
                        <div class="item">
                            <img src="image/Aqua One Goldfish Pellets.jpeg" height="150" width="150"/>
                            <br>
                            <h2>Aqua One Goldfish Pellets</h2>
                            <p>PRICE: $45.99</p>
                            <button class="add-to-cart" type="button">ADD TO CART</button>
                        </div>

                        <div class="item">
                            <img src="image/Bug Bites Cichlid Formula.jpeg" height="150" width="150"/><br>
                        ...
                        <div class="item">
                            <img src="image/Colour Kelp Pellets.jpeg" height="150" width="150"/><br>

                            <h2>Colour Kelp Pellets</h2>
                            <p>PRICE: $34.99</p>
                            <button class="add-to-cart" type="button">ADD TO CART</button>
                        </div>

                        <div class="item">
                            <img src="image/Krill & Shrimp Meal.jpeg" height="150" width="150"/>

                            <br>
                            <h2>Krill & Shrimp Meal</h2>
                            <p>PRICE: $12.99</p>
                            <button class="add-to-cart" type="button">ADD TO CART</button>
                        </div>
                        ...
                        <div class="item">
                            <img src="image/Small Fish Micro Granules.jpeg" height="150" width="150"/>

                            <br>
                    <h2>Small Fish Micro Granules</h2>
                    <p>PRICE: $13.99</p>
                    <button class="add-to-cart" type="button">ADD TO CART</button>
                </div>
